from inventariodiccionariofunciones import despedida, existencias, menutipomovimiento, entradas, salidas, bajas, menugestionproductos, agregarproductos, actualizarproductos, borrarproductos
inventario = {

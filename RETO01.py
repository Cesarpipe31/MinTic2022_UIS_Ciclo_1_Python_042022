...
# Con respecto a la situación planteada, deberás crear 3 variables que leerán un número FLOTANTE para el alto, ancho y profundo, 
# EN ESE ORDEN. Luego, crea una variable, con el nombre que desees, donde se guarde el cálculo del volumen del paquete, 
# y otra donde se guarde el cálculo del costo de envío. Finalmente, imprime el VOLUMEN del paquete y el COSTO del envío, 
# EN ESE ORDEN. 

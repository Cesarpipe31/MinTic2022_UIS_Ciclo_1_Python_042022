...
# empieces a plantear desde esta semana, igual será útil en la última semana.

# La empresa te indica que es fundamental que sigas el orden en el que ellos te indican los datos, puesto que el 
# sistema de ellos los arroja en un orden específico. La empresa te dice que ahora tienen una nueva política de 
# costos porque ahora deberán declarar IVA. Por esto, el costo de envío de un paquete, aunque seguirá siendo $5, 
...
# Por ejemplo, si un paquete mide 35 cm de alto, 10 cm de ancho y 5 cm de profundidad, el costo sería $8750, 
# pero como la altura es mayor a 30 cm, entonces se le aplica la tarifa adicional, quedando el costo en $10750. 
# Ahora, como el costo también es mayor a $10000, hay que sumarle el IVA (19%) quedando un valor de $12792.5.
...
# Con respecto a la situación planteada, usa el código de la semana pasada y agrega los elementos necesarios. 
# Usa un condicional IF que haga que se agregue 2000 al costo si la altura es mayor a 30 cm. Usa otro condicional 
# IF que haga que se agregue el IVA del costo si el costo es mayor a 10000.
...
# 3. Agrega un condicional if que verifique si la variable costo es mayor que 10000, en caso de cumplirse, 
# debes sumarle al costo su IVA, ten en cuenta que el IVA es del 19%.
